//codigo do mario edicao venezuela com musica
...
pinMode(buzzer, OUTPUT);    // para indicar o "Alto-falante"
}

void loop(){

   // Música Mario em loop, sem travar o jogo
  ...
  if (currentMillis - previousMillis >= noteDurations[currentNote]) {
    ...
    if (currentNote >= sizeof(melody)/sizeof(int)) {
      currentNote = 0; // reinicia a música
    }
  }
  //Fim do código da musica
